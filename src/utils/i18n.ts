...
export function t(key: string, lang: LanguageCode = 'el'): string {
...
export function translateUI(key: string, lang: LanguageCode = 'el', replacements?: Record<string, string>): string {
  const parts = key.split('.');
